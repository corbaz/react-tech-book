  ...
  return (
    <div className="flex-1 overflow-y-auto bg-white h-full relative animate-in fade-in duration-300">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex items-start justify-between mb-6">
            <div className="flex gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">{activeItem.name}</h1>
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge className="bg-blue-100 text-blue-700">{activeItem.category}</Badge>
      ...
      <div className="max-w-3xl mx-auto p-8">
        <AISection activeItem={activeItem} />
      </div>
    </div>
  );
};
